          ...
          {request.vehicles && (
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  request.vehicles.image_1_url,
                  request.vehicles.image_2_url,
                  request.vehicles.image_3_url,
                  request.vehicles.image_4_url,
                  request.vehicles.image_5_url,
                  request.vehicles.image_6_url,
                ].map((imageUrl, index) => (
                  <div key={index} className="relative">
                    {imageUrl ? (
                      <button
                        ...
                        className="w-full h-24 border-2 border-gray-300 rounded-lg overflow-hidden hover:border-red-600 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500"
                      >
                        <img
                          src={imageUrl}
